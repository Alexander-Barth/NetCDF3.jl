...
const NC_UBYTE  = 0x00000007 # CDF-5
const NC_USHORT = 0x00000008 # CDF-5
const NC_UINT   = 0x00000009 # CDF-5
const NC_INT64  = 0x0000000A # CDF-5
const NC_UINT64 = 0x0000000B # CDF-5
